    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
          {/* User Image */}
          <Image source={Images.user} style={{ height: 64, width: 64, borderRadius: 32 }} />
          <View>
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20 }}>
        <Image source={Images.Homebanner} style={{ height: 150, width: '100%' }} />
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: 30 }}>
          {DATA.map((data, index) => (
            <TouchableOpacity
              key={index}
              style={{ width: '30%', marginBottom: 16, alignItems: 'center', gap: 4 }}
